...
public class GetWatchdogStatisticsExample {

    private static final HypixelAPI API = HypixelAPI.create("31f966e6-bd4d-4800-b85e-b036d1134abf");

    public static void main(String[] args) throws IOException {
        try {
            WatchdogStatistics watchdog = API.getWatchdogStatistics();
            System.out.println("Total staff bans: " + watchdog.getTotalStaffBans());
        } finally {
            HypixelAPI.shutdown();
        }
    }
